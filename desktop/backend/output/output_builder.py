...
class OutputMixin:
    ...
    def _build_snapshot(self) -> EventSnapshot:
        ...
        return EventSnapshot(
            ...
            role_mentions=list(getattr(self, "discord_role_mentions", [])),
        )
    ...
    def update_output(self):
        ...
        if dpg.does_item_exist("output_text"):
            # Only auto-generate if 'Auto-update' is checked (prevents overwriting manual edits)
            if dpg.does_item_exist("auto_update_output"):
                if dpg.get_value("auto_update_output"):
